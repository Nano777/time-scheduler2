		...
		if(event.type == "message" && event.message.type == "text"){
			switch(true){
				...
				case /^[1-6]-[1-4]-[月火水木金]曜日-[1-6]-.*-.*/.test(event.message.text):
					...
					var values = [data[0], data[1], client.quote_literal(data[2]), data[3], client.quote_literal(data[4]), client.quote_literal(data[5]), client.quote_literal(event.source.user_id)]
